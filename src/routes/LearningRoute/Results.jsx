    ...
    return (
      <section className="results">
        <div className="shadow">
          ...
          <p className="display-feedback-p">
            The correct translation for {nextWord} was {answer} and you chose {guess}!
        </p>
        </div>
        <button className="next-button" type="button" onClick={() => { }}>Try another word!</button>
      </section >
    )
  }
